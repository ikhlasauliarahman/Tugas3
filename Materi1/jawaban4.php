...
<div class="w3-quarter">
  ...
  <h3> <?php echo $nama1 ?> </h3>
  <p>Web Designer</p>
</div>

<div class="w3-quarter">
  <img src="https://www.w3schools.com/w3images/avatar.jpg" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3> <?php echo $nama2 ?> </h3>
  <p>Support</p>
</div>
...
<div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-teal w3-bottombar">Contact Us</span></div>
      ...
      <p><i class="fa fa-map-marker w3-text-teal w3-xlarge"></i>  <?= $kota ?></p>
      <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i>  <?= $no_hp ?></p>
